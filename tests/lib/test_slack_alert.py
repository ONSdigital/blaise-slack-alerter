    ...
    send_alert.assert_called_with(
        SlackMessage(
            ...
            footnote=(
                ...
                "2. <https://console.cloud.google.com/monitoring/uptime?referrer=search&project=ons-blaise-v2-preprod | Check the system is online>\n"
    ...
    send_alert.assert_called_with(
        SlackMessage(
            ...
            footnote=(
                ...
                "3. <https://console.cloud.google.com/logs/query;query=%0A;cursorTimestamp=2022-07-22T20:36:22.219592062Z?referrer=search&project=ons-blaise-v2-prod | View the logs>\n"
                "4. Follow the <https://confluence.ons.gov.uk/pages/viewpage.action?pageId=98502389 | Managing Prod Alerts> process"
            ),
        )
    )
