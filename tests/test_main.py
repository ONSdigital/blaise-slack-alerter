...
def test_skip_execute_sql_alerts(run_slack_alerter, number_of_http_calls, caplog):
    ...
    example_log_entry = {
        "protoPayload": {
            "@type": "type.googleapis.com/google.cloud.audit.AuditLog",
            "status": {},
            "authenticationInfo": {"principalEmail": "jacob.west@ons.gov.uk"},
            "requestMetadata": {
                "callerIp": "212.59.77.245",
                "requestAttributes": {
                    "time": "2024-08-02T11:56:02.296502Z",
                    "auth": {},
                },
                "destinationAttributes": {},
            },
            ...
            "request": {
                ...
                "body": {"database": "blaise", "user": "thorne1"},
            },
        },
        "insertId": "-xjdb8oearmmu",
        "resource": {
        ...
        "timestamp": "2024-08-02T11:56:00.713295Z",
        "severity": "INFO",
        "logName": "projects/ons-blaise-v2-prod/logs/cloudaudit.googleapis.com%2Fdata_access",
