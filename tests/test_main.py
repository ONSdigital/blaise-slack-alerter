    ...
    assert json.loads(
        ...
        SlackMessage(
            ...
            footnote=(
                ...
                "2. <https://console.cloud.google.com/monitoring/uptime?referrer=search&project=project-dev "
                "| Check the system is online>\n"
                "3. <https://console.cloud.google.com/logs/query;query=resource.type:%22gce_instance%22%20resource.labels.instance_id:%2289453598437598%22%20severity%3D%28WARNING%20OR%20ERROR%20OR%20CRITICAL%20OR%20ALERT%20OR%20EMERGENCY%20OR%20DEBUG%29;timeRange=2022-08-02T19:06:42.275819Z%2F2022-08-02T19:06:42.275819Z--PT1M?referrer=search&project=project-dev "
                "| View the logs>\n"
                "4. Follow the <https://confluence.ons.gov.uk/pages/viewpage.action?pageId=98502389 "
                "| Managing Prod Alerts> process"
            ),
    ...
    assert json.loads(
        ...
        SlackMessage(
            ...
            footnote=(
                ...
                "| Check the system is online>\n"
                "3. "
                "<https://console.cloud.google.com/logs/query;query=resource.type:%22cloud_function%22%20resource.labels.function_name:%22log-error%22%20severity%3D%28WARNING%20OR%20ERROR%20OR%20CRITICAL%20OR%20ALERT%20OR%20EMERGENCY%20OR%20DEBUG%29;timeRange=2022-07-22T20:36:22.219592Z%2F2022-07-22T20:36:22.219592Z--PT1M?referrer=search&project=project-dev "
                "| View the logs>\n"
                "4. Follow the <https://confluence.ons.gov.uk/pages/viewpage.action?pageId=98502389 "
                "| Managing Prod Alerts> process"
            ),
    ...
    assert json.loads(
        ...
        SlackMessage(
            ...
            footnote=(
                ...
                "| Check the system is online>\n"
                "3. "
                "<https://console.cloud.google.com/logs/query;query=resource.type:%22cloud_function%22%20resource.labels.function_name:%22log-error%22%20severity%3D%28WARNING%20OR%20ERROR%20OR%20CRITICAL%20OR%20ALERT%20OR%20EMERGENCY%20OR%20DEBUG%29;timeRange=2022-12-15T04:09:02.428095Z%2F2022-12-15T04:09:02.428095Z--PT1M?referrer=search&project=project-dev "
                "| View the logs>\n"
                "4. Follow the <https://confluence.ons.gov.uk/pages/viewpage.action?pageId=98502389 "
                "| Managing Prod Alerts> process"
            ),
    ...
    assert json.loads(
        ...
        SlackMessage(
            ...
            footnote=(
                ...
                "| Check the system is online>\n"
                "3. "
                "<https://console.cloud.google.com/logs/query;query=resource.type:%22gae_app%22%20resource.labels.module_id:%22app-name%22%20severity%3D%28WARNING%20OR%20ERROR%20OR%20CRITICAL%20OR%20ALERT%20OR%20EMERGENCY%20OR%20DEBUG%29;timeRange=2022-08-03T14:48:46.538301Z%2F2022-08-03T14:48:46.538301Z--PT1M?referrer=search&project=project-dev "
                "| View the logs>\n"
                "4. Follow the "
    ...
    assert json.loads(
        ...
        SlackMessage(
            ...
            footnote=(
                ...
                "| Check the system is online>\n"
                "3. "
                "<https://console.cloud.google.com/logs/query;query=protoPayload.@type:%22type.googleapis.com/google.cloud.audit.AuditLog%22%20severity%3D%28WARNING%20OR%20ERROR%20OR%20CRITICAL%20OR%20ALERT%20OR%20EMERGENCY%20OR%20DEBUG%29;timeRange=2022-09-06T21:32:11.332410Z%2F2022-09-06T21:32:11.332410Z--PT1M?referrer=search&project=project-dev "
                "| View the logs>\n"
                "4. Follow the "
                "<https://confluence.ons.gov.uk/pages/viewpage.action?pageId=98502389 "
                "| Managing Prod Alerts> process"
